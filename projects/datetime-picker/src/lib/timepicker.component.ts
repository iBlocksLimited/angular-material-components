...
export class NgxMatTimepickerComponent<D> implements ControlValueAccessor, OnInit, OnChanges {
  ...
  writeValue(val: D): void {
    if (val != null) {
      ...
      if (this.defaultTime != null) {
        this._model = this._dateAdapter.createDateWithDefaultTime(this._model, this.defaultTime);
      }
    }
  ...
  private _updateModel() {
    ...
    this._model = this._dateAdapter.createDateWithTime(this._model, _hour, this.minute, this.second);
